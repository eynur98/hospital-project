                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Slayderlər</h4>
                            <button type="button"
                                ...
                                @foreach($slider as $partner)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{route('slider.destroy',$partner->id)}}" method="post">
                                                @method('delete')
                                                @csrf
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="partners_modalLabel">Slayder Əlavə Et</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                            </div>
                            <div class="modal-body">
                                <form action="{{route('slider.store')}}" id="partner_form" method="post"  enctype='multipart/form-data'>
                                   @csrf
        ...
        $('#checkbox').prop("checked", false)
           ...
           $.ajax({
               ...
               success: function(data)
               {
                   ...
                   $('#titleInput').val(data.link_title)
