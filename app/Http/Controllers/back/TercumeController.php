...
class TercumeController extends Controller
{
    /**
    ...
    {
        return view('back.tercume.index',['tercume'=>Tercume::paginate(10), 'languages'=>Language::where('status', 1)->get()]);
    }
